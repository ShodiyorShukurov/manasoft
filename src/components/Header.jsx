  ...
  useEffect(() => {
    const updateMenuHeight = () => {
      if (showMobileMenu && mobileMenuRef.current) {
        ...
        mobileMenuRef.current.style.height = `${windowHeight}px`; 
      }
    };
  ...
  return (
    ...
    >
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-base">
                  {selectedLang.slice(0, 1).toUpperCase() +
      ...
      {showMobileMenu && (
        <nav
          ref={mobileMenuRef}
          className="fixed top-0 left-0 xl:hidden bg-black w-full z-50 overflow-y-auto h-screen"
        >
          <button
