...
const portfolio3 = (t) => ({
  portfolioData: {
    ...
    banner_button1_link:
      "https://play.google.com/store/apps/details?id=com.evosoft_solutions.medagent",
    banner_image: banner,
    banner_property1: t("project3.banner_property1"),
    banner_property2: t("project3.banner_property2"),
