...
const portfolio9 = (t) => ({
  portfolioData: {
    id: 9,
    banner_title: t('project9.banner_title'),
    banner_subtitle: t('project9.banner_subtitle'),
    banner_text: t('project9.banner_text'),
    banner_button3: t('project9.banner_button3'),
    banner_button3_link: 'https://t.me/Lifeplanneruz_bot',
    banner_image: banner,
    banner_property1: t('project9.banner_property1'),
    title: t('project9.project_title'),
    cards: [
      {
        id: 1,
        title: t('project9.project_card1_title'),
        text: t('project9.project_card1_text'),
