...
const Customers = () => {
  return (
    <section className="pt-[120px]">
      ...
      {/* <InfiniteCarousel className="mt-[32px] md:mt-[48px]">
        <ul className="flex gap-4 md:gap-8">
          {[...Array(3)].map((_, index) => (
            <li key={index} className="p-[24px] md:p-[32px] border border-[#333] rounded-[20px] md:rounded-[30px] bg-[#ffffff0a] text-white w-[80%] md:w-auto flex-shrink-0">
